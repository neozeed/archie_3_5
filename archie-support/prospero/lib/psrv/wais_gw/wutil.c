 ...
 *   request message into the specified buffer.
 ...
 */
void dsply_doc_hdr_record( record)
...
void dsply_short_hdr_record( record)
...
long *buff_len;          
{
  ...
  info =  makeWAISInitResponse(  CT_paragraph 
			       ,3 
			       ,chunk_marker 
			       ,highl_marker 
			       ,dhighl_marker 
  ...
  response = makeInitResponseAPDU( ACCEPT, 
				  WILL_USE,WILL_NOT_USE,WILL_NOT_USE, 
				  WILL_NOT_SUPPORT,WILL_NOT_SUPPORT, 
				  1024L, 2048L, 
				  NULL,	
...
void twais_tmplt_typ3_srch_apdu( buff, buff_len)
char *buff;             
long *buff_len;          
{
  ...
  query = makeWAISSearch( "Supercomputers in Taiwan", 
			 0L,	
			 0L,
			 1L,	
			 0L,	
...
long *buff_len;
{
  ...
  doc_headers[0] = makeWAISDocumentHeader(
					  ...
					  "Source1", 
					  "19900115", 
					  "CRAY sells supercomputer to Taiwan",	
					  "New York"); 
  ...
  records = makeWAISSearchResponse( "Supercomputer Taiwan" 
				   ,doc_headers	
				   ,0 ,0 ,0 ,0 
				   ,0 
				   ,NULL 
  ...
  response = makeSearchResponseAPDU( SUCCESS 
				    ,2 
				    ,2 
				    ,0 
				    ,0 
...
long *buff_len;
{
  ...
  records = makeWAISSearchResponse( 0 
				   ,0 ,0 ,0 
				   ,doc_text ,0	
				   ,0 
				   ,NULL 
